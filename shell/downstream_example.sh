...
# CIFAR100
CUDA_VISIBLE_DEVICES=0 python main.py --task classification --gpus 0 --setname CIFAR100 --num_repeat 3 --num_workers 16 --epochs 100 --save_point 80 --batch_size 256 --lr 2e-4 --model_name resnet50 --sup_method common --optim adam &&
CUDA_VISIBLE_DEVICES=0 python main.py --task classification --gpus 0 --setname CIFAR100 --num_repeat 3 --num_workers 16 --epochs 100 --save_point 80 --batch_size 256 --lr 2e-4 --model_name resnet50 --sup_method common --optim adam --pretrained 2 --freeze_weight 3 --weight_name rotation_resnet50_wrmix5_30rr_v2_bshuffle_minr6_e200bs1024_Exp2.pth
## 5nn
CUDA_VISIBLE_DEVICES=0 python main.py --task classification --gpus 0 --setname CIFAR100 --num_repeat 3 --num_workers 16 --epochs 100 --save_point 80 --batch_size 256 --lr 2e-4 --model_name resnet50 --sup_method common --optim adam --clsval_mode 5nn &&
CUDA_VISIBLE_DEVICES=0 python main.py --task classification --gpus 0 --setname CIFAR100 --num_repeat 3 --num_workers 16 --epochs 100 --save_point 80 --batch_size 256 --lr 2e-4 --model_name resnet50 --sup_method common --optim adam --clsval_mode 5nn --pretrained 2 --freeze_weight 3 --weight_name rotation_resnet50_wrmix5_30rr_v2_bshuffle_minr6_e200bs1024_Exp2.pth
...
# ISIC2018T1
CUDA_VISIBLE_DEVICES=0 python main.py --task segmentation --gpus 0 --setname ISIC2018T1 --num_repeat 3 --num_workers 16 --epochs 100 --save_point 80 --batch_size 32 --lr 1e-6 --warmup_init_lr 5e-5 --max_lr 5e-4 --model_name resnet50 --sup_method common --optim adam --seg_head_name deeplabv3plus &&
CUDA_VISIBLE_DEVICES=0 python main.py --task segmentation --gpus 0 --setname ISIC2018T1 --num_repeat 3 --num_workers 16 --epochs 100 --save_point 80 --batch_size 32 --lr 1e-6 --warmup_init_lr 5e-5 --max_lr 5e-4 --model_name resnet50 --sup_method common --optim adam --seg_head_name deeplabv3plus --pretrained 2 --freeze_weight 3 --weight_name rotation_resnet50_wrmix5_30rr_v2_bshuffle_minr6_e200bs1024_Exp2.pth
