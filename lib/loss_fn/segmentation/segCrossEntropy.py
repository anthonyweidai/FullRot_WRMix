...
class SegCrossEntropy(BaseCriteria):
    ...
    def __init__(self, opt, **kwarg: Any):
        super(SegCrossEntropy, self).__init__(opt, **kwarg)
    ...
    def forward(self, Input: Tensor, Prediction: Tensor or Tuple[Tensor, Tensor], Target: Tensor) -> Tensor:
        AuxOut = None
