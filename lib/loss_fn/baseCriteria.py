...
class BaseCriteria(nn.Module):
    def __init__(self, opt, Task=None, **kwargs):
    ...
    def forward(
        self, Input: Any, Prediction: Any, Target: Any, **kwargs
    ) -> Tensor:
